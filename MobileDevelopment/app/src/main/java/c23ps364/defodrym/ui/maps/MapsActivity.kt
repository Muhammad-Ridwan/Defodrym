...
class MapsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (name != null) {
            ...
            searchUrl = "https://www.google.com/maps/search/?api=1&query=${Uri.encode(name)}&ll=' + lat + ',' + lng + '&radius=0.00000001"
            ...
            searchUrl = "https://www.google.com/maps/search/?api=1&query=${Uri.encode(name)}&radius=0.00000001"
            webView.loadUrl(searchUrl)
        }
